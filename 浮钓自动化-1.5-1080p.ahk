...
5|[Pause]|NoRandom|1|222|Sleep|||||7|
6|Continue, Continue, FoundX, FoundY, 1|1245, 710, 1494, 784, *88 mate\自重漂z1.png|1|0|ImageSearch||Screen|||8|
7|If Image/Pixel Not Found||1|0|If_Statement|||||11|
8|[Pause]|NoRandom|1|222|Sleep|||||13|
...
15|[End If]|EndIf|1|0|If_Statement|||||23|
16|[End If]|EndIf|1|0|If_Statement|||||24|
17|[End If]|EndIf|1|0|If_Statement|||||25|
18|Continue, Continue, FoundX, FoundY, 0|612, 74, 1305, 227, *5 mate\标1.png|1|0|ImageSearch||Screen|||26|
19|If Image/Pixel Found||1|0|If_Statement|||||28|
20|[Assign Variable]|godone := 0|1|0|Variable|Expression||||30|
21|[End If]|EndIf|1|0|If_Statement|||||31|

[PMC Code v5.4.1]|||1|Window,2,Fast,0,1,Input,-1,-1,1|1|scan2()
Context=None|
Groups=Start:1
1|[FunctionStart]|scan2|1|0|UserFunction|Local| / |||1|
2|beep|_null := |1|0|Function|||||3|
3|scan21|_null := |1|0|Function|||||4|
4|[Pause]|NoRandom|1|333|Sleep|||||5|
...
2|beep|_null := |1|0|Function|||||3|
3|Continue, Continue, FoundX, FoundY, 0|551, 79, 1323, 229, *5 mate\星1.png|1|0|ImageSearch||Screen|||4|
4|If Image/Pixel Not Found||1|0|If_Statement|||||6|
5|Continue, Continue, FoundX, FoundY, 0|612, 72, 1286, 236, *5 mate\标1.png|1|0|ImageSearch||Screen|||8|
6|If Image/Pixel Found||1|0|If_Statement|||||10|
7|SoundBeep|140, 100|1|0|SoundBeep|||||12|
8|Space|{Space}|1|0|ControlSend||ahk_exe rf4_x64.exe|||13|
9|[Pause]||1|300|Sleep|||||14|
10|Space|{Space}|1|0|ControlSend||ahk_exe rf4_x64.exe|||15|
11|[End If]|EndIf|1|0|If_Statement|||||16|
12|If Image/Pixel Not Found||1|0|If_Statement|||||17|
13|SoundBeep|4444, 33|1|0|SoundBeep|||||19|
14|SoundBeep|4444, 33|1|0|SoundBeep|||||20|
15|[Pause]||1|300|Sleep|||||21|
16|Continue, Continue, FoundX, FoundY, 0|612, 74, 1305, 227, *5 mate\标1.png|1|0|ImageSearch||Screen|||22|
17|If Image/Pixel Not Found||1|0|If_Statement|||||24|
18|SoundBeep|188, 100|1|0|SoundBeep|||||26|
19|[Pause]||1|300|Sleep|||||27|
20|Backspace|{Backspace}|1|0|ControlSend||ahk_exe rf4_x64.exe|||28|
21|[End If]|EndIf|1|0|If_Statement|||||29|
22|[End If]|EndIf|1|0|If_Statement|||||30|
23|[End If]|EndIf|1|0|If_Statement|||||31|
24|If Image/Pixel Found||1|0|If_Statement|||||32|
25|SoundBeep|140, 100|1|0|SoundBeep|||||34|
26|Space|{Space}|1|0|ControlSend||ahk_exe rf4_x64.exe|||35|
27|[Pause]||1|300|Sleep|||||36|
28|Space|{Space}|1|0|ControlSend||ahk_exe rf4_x64.exe|||37|
29|[End If]|EndIf|1|0|If_Statement|||||38|
...
2|beep|_null := |1|0|Function|||||3|
3|Continue, Continue, FoundX, FoundY, 0|626, 965, 759, 1005, *88 mate\T.png|1|0|ImageSearch||Screen|||4|
4|If Image/Pixel Found||1|0|If_Statement|||||6|
5|Enter|{Enter Down}|1|0|ControlSend||ahk_exe rf4_x64.exe|||8|
6|[Pause]|Random|1|444|Sleep|555||||9|
7|Enter|{Enter Up}|1|0|ControlSend||ahk_exe rf4_x64.exe|||10|
8|[End If]|EndIf|1|0|If_Statement|||||11|
9|[Pause]||1|4200|Sleep|||||12|
10|SoundBeep|7777, 33|1|0|SoundBeep|||||13|
11|SoundBeep|4444, 33|1|0|SoundBeep|||||14|
12|SoundBeep|7777, 33|1|0|SoundBeep|||||15|
13|eat|_null := |1|0|Function|||||16|
